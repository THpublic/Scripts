...
New-ItemProperty -LiteralPath 'HKEY_Users:\Netloan_User\Software\Microsoft\Windows NT\CurrentVersion\Windows' -Name 'Device' -Value 'Idea Store Canary Wharf Public Printer,winspool,Ne00:' -PropertyType String -Force -ea SilentlyContinue;
