...
New-ItemProperty -LiteralPath 'Registry::\HKEY_USERS\Netloan_User\Software\Microsoft\Windows\CurrentVersion\RunOnce' -Name 'RunSetUserFTA' -Value '"C:\Windows\system32\SetFileAssocW11.bat"' -PropertyType String -Force -ea SilentlyContinue;
